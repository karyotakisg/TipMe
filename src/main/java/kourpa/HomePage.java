...
public class HomePage {
    ...
    String [] posts = {"Messi = G.O.A.T ", "Agapitou fermarei tin agapao tin latrevo me trelainei me exei kleidosei den antexo sagapao, os olympiacos eimai fan ok messi>ronaldo ", "Messi>>>Siuu haha", "Estia mono", "Ollandia poulo"};
